...
| Wander / indoors | Configured wander radius (35 m at every stop) and current interior classification. This does not prevent a target from walking indoors. The gameplay search circle uses the same radius and follows assigned stop changes. |
