...
foreach ($bountyConstant in @('kArmedChancePct', 'kGunVsKnifePct', 'kReAggroSightDist', 'kRetainSightDist', 'kDeAggroGraceMs', 'kTargetSearchMs', 'kCombatSettleMs', 'kCombatScenarioExitMs')) {
