...
Targets keep one weapon loadout: setup removes inherited weapons once before choosing fists, knife or revolver. They pursue with the game's combat AI and search the last place they saw you after losing sight for eight seconds. Engagement and search ask targets to leave any ambient scenario or seat before receiving their new task. A combat request gets 2.5 seconds to settle; a still-seated or queued engagement then enters the one-second missing-task grace and three-second retry limit. Seated combat recovery clears the stuck task immediately without drawing the weapon again. After ten seconds of searching, targets resume an available scheduled destination once combat and restraint have ended. They remember you and can re-engage on sight. Recovery does not interrupt ragdoll, getting up, lasso, hogtying or fully hogtied states. Flee bit 32768 follows the paired armed-enemy/flee transition in Flaco's mission; the full evidence and other retained flags are in [the AI audit](docs/target-ai-audit.md). See the [seated-target fix and in-game checklist](docs/seated-target-fix-2026-09-07.md).
