...
The first diagnostic (`photo-test-v1`) passed repeated captures, released-download reopening, and a different NPC after 56 seconds. It also passed after opening and closing the handheld camera without taking a photo. Those observations do not establish fresh pixels or reproduce the real contract failure. The current `photo-test-v2` adds the missing card inspection before the reopen/write probes.
