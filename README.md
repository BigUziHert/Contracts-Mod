...
Targets follow daily walking routes in Rhodes, Blackwater, Valentine, Strawberry, Saint Denis, Van Horn and Annesburg. Each contract selects four regular haunts from 60 outdoor candidate areas, including yards, docks, markets, stations, theatre entrances and shop frontages. Every stop uses a **45 m wander radius** and a matching **45 m search circle**. Travel switches to native area wandering as soon as the target enters the next stop's 45 m area, without requiring a walk to its centre. The search circle stays at the previous stop during travel and moves to the new stop on that entry. The card lists the target's occupation, town and usual day, afternoon, evening and late-hour destinations. The game can choose ambient pauses such as smoking. The mod does not force smoking or drinking stops or impose their duration. See [the radius, location and startup changes](docs/routine-radius-and-startup-2026-09-07.md).
